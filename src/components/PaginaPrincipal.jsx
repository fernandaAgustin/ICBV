        ...
        <div className={`pagina-principal ${modoClaro ? 'modo-claro' : 'modo-oscuro'}`}>
            ...
            <header className="hero-section d-flex align-items-center justify-content-center">
                <video autoPlay loop muted playsInline className="hero-video">
                    <source src="https://videocdn.cdnpk.net/videos/6872df75-27b9-544a-b02a-fe3b57a645f8/horizontal/previews/clear/large.mp4?token=exp=1745134771~hmac=e2280df6d7c201550246682be3347efb32fc461fb025a24b9c4045d9889f920b" type="video/mp4" />
